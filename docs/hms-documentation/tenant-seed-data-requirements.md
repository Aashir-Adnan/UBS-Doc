...
| `max_quantity_per_booking` | Max times service can be booked in one reservation (default: 1) | `maxQuantityPerBooking` |
...
| `max_quantity_per_booking` | Max times package can be booked in one reservation (default: 1) | `maxQuantityPerBooking` |
