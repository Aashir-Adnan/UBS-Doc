...
| 12 | `PG-SERVICE-MGR` | active | 150 | Service Manager (`<service-category>` designation, e.g. `STAY`) |
...
- **Status:** `active`
- **Total active permissions:** 150

**By tier:** framework: 20, tenant: 14, service: 110, common: 6
