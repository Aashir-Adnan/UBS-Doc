...
> **Governance groups** are the active global rows **9–12** plus **19** (`PG-STANDARD-GUEST`, guest persona — no permissions seeded yet). Ids **13–16** are inactive duplicate copies and carry **no active permission mappings**.

### 1.2 Legacy / test groups

| `permission_group_id` | Group name | Status | Active permissions |
|---|---|---|---:|
| 1 | `Legacy_SuperAdmin` | inactive | 5 |
| 2 | `Front Desk Staff` | active | 3 |
| 3 | `Housekeeping & Maintenance` | active | 3 |
| 4 | `Kids Center Manager` | active | 3 |
| 5 | `Test-ABC` | active | 3 |
| 6 | `TEST1-ABC123` | active | 3 |
| 7 | `Manager-22` | active | 2 |
| 8 | `Designation-Teacher fellow-24` | active | 2 |
| 17 | `dummy -DUM` | active | 0 |

> Pre-governance / scratch rows, not part of the persona model.

### 1.3 Per-tenant cloned governance groups (ids 20–91)
...
### Group 2 — `Front Desk Staff`

*Access to bookings, guest profiles, and room management*
...
### Group 3 — `Housekeeping & Maintenance`

*Access to tasks and service logs only*
...
### Group 4 — `Kids Center Manager`

*Access to kids center registrations and alerts*

- **Status:** `active`
- **Total active permissions:** 3

**By tier:** tenant: 1, service: 2

<details>
<summary><b>tenant</b> (1)</summary>
...
- **Status:** `active`
- **Total active permissions:** 2

**By tier:** tenant: 2

<details>
<summary><b>tenant</b> (2)</summary>
...
### Group 8 — `Designation-Teacher fellow-24`
