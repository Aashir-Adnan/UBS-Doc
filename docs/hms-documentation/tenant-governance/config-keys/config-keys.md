...
| Date | Change |
|---|---|
| 2026-09-02 | **Catalog figures refreshed against the connected `dev-restructure_hms_1.9` DB** — see [config-keys-catalog.md → Current state](./config-keys-catalog/config-keys-catalog.md#current-state-refreshed-2026-09-02-against-dev-restructure_hms_19): 211 original keys (80 active / 131 inactive), 6,102 clone rows / 2,320 active across 40 tenants, and **6** constrained key names (see [config-constraints.md](../config-constraints/config-constraints.md)). This page's conceptual model is unchanged. |
