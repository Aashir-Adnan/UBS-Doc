...
import { Database, Map, Activity, Bell, Zap, FolderOpen, GitBranch, MessageSquare, FolderGit2, BarChart3, Shield, LogOut, ListChecks } from 'lucide-react'
...
const TOOLS = [
  ...
  { label: 'Tasks', desc: 'Project tasks, owners and blockers', Icon: ListChecks, route: '/tools/tasks', from: '#F59E0B', to: '#EF4444' },
