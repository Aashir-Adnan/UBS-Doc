...
function toFirebaseConfig(runtimeKeys = {}) {
  ...
  return {
    ...
    storageBucket:
      runtimeKeys.FIREBASE_STORAGE_BUCKET || fallback.storageBucket || "",
    messagingSenderId:
      runtimeKeys.FIREBASE_MESSAGING_SENDER_ID ||
      fallback.messagingSenderId ||
      "",
    appId: runtimeKeys.FIREBASE_APP_ID || fallback.appId || "",
    measurementId:
      runtimeKeys.FIREBASE_MEASUREMENT_ID || fallback.measurementId || "",
  };
}
