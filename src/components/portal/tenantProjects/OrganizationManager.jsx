...
function friendlyError(msg) {
  ...
  if (isExpiredConnection(msg))
    return "Your GitHub connection expired. Please click Connect again.";
    ...
    <div className="tenant-wizard">
      <ol className="tenant-wizard-steps" aria-hidden="true">
        {[
          ...
          <li
            key={s.k}
            className={`tenant-wizard-step${step === s.k ? " is-active" : ""}`}
          >
      ...
      {step === STEPS.DETAILS && (
        <form className="tenant-form" onSubmit={handleDetailsNext}>
          ...
          <button type="submit" className="tenant-submit">
            Next
          </button>
      ...
      {step === STEPS.CONNECT && (
        <div className="tenant-form">
          <p className="tenant-muted">
            Connect a GitHub organization to import its repositories, or create
            the organization without GitHub — you can add repositories later.
          </p>
                ...
                >
                  {o.avatar_url ? (
                    <img
                      src={o.avatar_url}
                      alt=""
                      className="tenant-member-img"
                    />
                  ) : (
                    <span className="tenant-member-initial">
                      {o.login.charAt(0).toUpperCase()}
                    </span>
                  )}
              ...
              {repos.map((r) => (
                <label key={r.full_name} className="tenant-checkbox-row">
                  ...
                  <span>
                    ...
                    {r.private && (
                      <span className="tenant-repo-badge tenant-repo-badge-private">
                        private
                      </span>
                    )}
                    {r.archived && (
                      <span className="tenant-repo-badge tenant-repo-badge-archived">
                        archived
                      </span>
                    )}
                    {r.default_branch && (
                      <span className="tenant-repo-badge">
                        {r.default_branch}
                      </span>
                    )}
                  </span>
  ...
  return (
    <div>
      ...
      <div className="portal-card">
        ...
        {tab === "settings" && (
          <SettingsPanel email={email} org={selectedOrg} onDone={loadOrg} />
        )}
