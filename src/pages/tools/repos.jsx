    ...
    <div>
      <div className="gh-panel-header" style={{ marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          ...
          <button type="button" className="gh-submit-btn" style={{ fontSize: '0.85rem', padding: '0.35rem 0.9rem' }}
...
function ReposContent() {
  ...
  return (
    <>
      <div className="portal-breadcrumb"><Link to="/tools">← Back to Dev Tools</Link></div>
