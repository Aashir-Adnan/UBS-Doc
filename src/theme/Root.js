...
export default function Root({ children }) {
  ...
  useEffect(() => {
    if (typeof document === "undefined") return;
    const show =
      typeof window !== "undefined" ? window.__TILE_OUTLINES__ !== false : true;
        ...
        <AuthGate>
          <div className="ubs-app-shell">
            <aside className="ubs-side-nav">
              ...
              >
                <span
                  className={`ubs-theme-toggle-track${theme === "dark" ? " is-dark" : ""}`}
                >
                  <span
                    className="ubs-theme-icon ubs-theme-icon--sun"
                    aria-hidden="true"
                  >
                    ☀
                  </span>
                  <span
                    className="ubs-theme-icon ubs-theme-icon--moon"
                    aria-hidden="true"
                  >
                    ☾
                  </span>
                  <span
                    className={`ubs-theme-thumb${theme === "dark" ? " is-dark" : ""}`}
                  />
                </span>
            ...
            <div
              className={`ubs-page-stage${transitioning ? " is-transitioning" : ""}`}
            >
              {children}
            </div>
            <div
              className={`ubs-route-fade${transitioning ? " is-active" : ""}`}
            />
            {showWelcome && (
              <div
  ...
  if (!user) {
    return (
      ...
      >
        ...
        >
          <h2 style={{ margin: "0 0 8px", color: "#093C5D" }}>
            Sign in to UBS
          </h2>
